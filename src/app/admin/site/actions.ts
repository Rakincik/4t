...
export async function updateSiteConfig(formData: FormData) {
    ...
    const data = {
        ...
        headerAnnouncement: formData.get("headerAnnouncement") as string || "Geleceğe Hazırlık",
    };
    ...
    revalidatePath("/", "layout"); // Revalidate entire app cache
