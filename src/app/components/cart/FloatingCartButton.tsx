...
export default function FloatingCartButton() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute -top-1 -right-1 bg-white text-[#DC2626] font-extrabold text-[11px] w-6 h-6 rounded-full flex items-center justify-center border-2 border-[#DC2626] shadow-sm">
        {itemsCount}
      </span>
    </button>
  );
