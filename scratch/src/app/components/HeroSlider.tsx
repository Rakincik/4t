...
export default function HeroSlider({ slides }: HeroSliderProps) {
    ...
    return (
        <section className="relative h-[85vh] min-h-[600px] w-full overflow-hidden bg-[#0B1221]">
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    {/* Content */}
                    <div className="relative h-full container mx-auto max-w-7xl px-4 flex items-center">
            ...
            {/* Navigation Buttons */}
            <div className="absolute bottom-12 right-4 md:right-12 flex gap-4 z-20">
                <button
                    onClick={prevSlide}
            ...
            {/* Dots */}
            <div className="absolute bottom-12 left-4 md:left-1/2 md:-translate-x-1/2 flex gap-3 z-20">
                {slides.map((_, idx) => (
                    <button
                        key={idx}
