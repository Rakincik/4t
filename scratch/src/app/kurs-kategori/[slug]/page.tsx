...
/* ------------------------------------------------------------------ */
/* LEAD FORM COMPONENT (same file for easy copy-paste)                */
/* ------------------------------------------------------------------ */
function LeadForm({ presetExam, source }: { presetExam: string; source: string }) {
  const [name, setName] = (require("react") as typeof import("react")).useState("");
  const [phone, setPhone] = (require("react") as typeof import("react")).useState("");
  const [exam, setExam] = (require("react") as typeof import("react")).useState(presetExam);
