...
"use client"; // Filtreleme (state) için bu şart
...
export default function SuccessPage() {
  ...
  // Filtreleme Mantığı
  const filteredSuccesses = allSuccesses.filter(story => {
      ...
      <section className="w-full bg-white pt-20 pb-16 border-b border-gray-200">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-xl text-gray-600 max-w-3xl mx-auto">
            4T Akademi ailesi olarak, hayallerine ulaşan öğrencilerimizin
            başarılarını paylaşmaktan gurur duyarız.
          </p>
        </div>
      </section>
