...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var prisma, _i, CATEGORIES_1, c;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../src/lib/prisma")); })];
                case 1:
                ...
                case 3:
                    _a.sent();
                    console.log("Eklendi/Var olan korundu: ".concat(c.name));
                    _a.label = 4;
                case 4:
                    _i++;
                    return [3 /*break*/, 2];
